...
const rows = [
  ...
  ["beef mince","282470731","Tesco Lean Beef Steak Mince 5% Fat 750g",1250,"g",750,2,1500,14.3,["EVT-2026-08-15-TESCO-LEAN-BEEF-STEAK-MINCE-5-FA-CORRECTION-d2489547"],"rec2cuA1Lc6M17y4h"],
  ...
  ["Garlic","313168547","Tesco Large Garlic",1,"each",1,1,1,0.5,["EVT-2026-08-15-GARLIC-CORRECTION-0d922ef8"],"recuZb0sFtT5qCOuy"],
  ...
  ["salad leaves","292593115","Tesco Mixed Leaf Salad 120G",240,"g",120,2,240,2.4,[],"recpXYJGcE0P6SwTQ"],
  ["Tesco Red Peppers Each","258421636","Tesco Red Peppers Each",4,"each",1,4,4,2.8,["EVT-2026-08-15-RED-PEPPER-CORRECTION-8c3bc388"],"rec2ZUJVg9FsLb7q8"],
  ...
  ["breaded fish","266195171","Tesco 4 Breaded Cod Fillets 500G",12,"portion",4,3,12,12,[],"recL960U4c5jQFvQt"],
  ...
  ["large quiche","288017298","Tesco Quiche Lorraine 400g",2,"item",1,2,2,5,[],"recy7ECAsHytZRWjW"],
  ["baked beans","256947789","Tesco Baked Beans In Tomato Sauce 4X420g",4,"x400g can",4,1,4,1.55,[],"rectiGaLob6U6eH1Z"],
  ["burger buns","301971576","St Pierre Plain Brioche Burger Buns 6 Pack",6,"item",6,1,6,2.9,[],"reclUHcloK0WgDoO7"],
  ["kidney beans","259061829","Tesco Red Kidney Beans In Water 400G",3,"x400g can",1,3,3,1.17,[],"recXNtY84dSH16WPl"],
  ["parmesan","255081368","Tesco Grated Parmigiano Reggiano 100G",100,"g",100,1,100,2.8,[],"recO9TrGr3IDDzM9y"],
  ["houmous","320967265","Tesco Houmous 300g",200,"g",300,1,300,1.5,["EVT-2026-08-15-TESCO-HOUMOUS-200G-CORRECTION-2c7f82c6"],"rec7NwbQ87VSbh3r6"],
  ["lettuce","253557495","Tesco Iceberg Lettuce Each",2,"each",1,2,2,1.78,[],"recxl6Kz3Sfov7qWF"],
] as const;

const lines = rows.map(
  ([itemKey,sku,productName,requiredQuantity,unit,packSize,packCount,orderedQuantity,lineCost,sourceEventIds,requirementId]) => ({
    itemKey, sku, productName, productUrl: productUrls[sku], retailer: "Tesco", requiredQuantity, unit,
