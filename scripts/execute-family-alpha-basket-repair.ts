...
const productUrls: Record<string, string> = {
  ...
  "TESCO-CHICKEN-1KG":
    "https://www.tesco.com/shop/en-GB/search?query=tesco+chicken+breast+fillet+1kg",
  ...
  "TESCO-LEMONS-EACH":
    "https://www.tesco.com/shop/en-GB/search?query=Tesco+Lemons+Each",
  "299538966":
...
const rows = [
  ...
  [
    ...
    14.3,
    [
      "EVT-2026-08-15-TESCO-LEAN-BEEF-STEAK-MINCE-5-FA-CORRECTION-d2489547",
    ],
    "rec2cuA1Lc6M17y4h",
  ],
  [
    ...
    800,
    0.94,
    ["EVT-2026-08-15-TESCO-ITALIAN-CHOPPED-TOMATOES-4-CORRECTION-3559044e"],
    "rec6vfdbvu8F72bHc",
  ],
  [
    "Garlic",
    ...
    1,
    0.5,
    ["EVT-2026-08-15-GARLIC-CORRECTION-0d922ef8"],
    "recuZb0sFtT5qCOuy",
  ],
  ...
  [
    ...
    4,
    2.8,
    ["EVT-2026-08-15-RED-PEPPER-CORRECTION-8c3bc388"],
    "rec2ZUJVg9FsLb7q8",
  ],
  [
    "Chicken breast",
    ...
    1000,
    6.69,
    ["EVT-2026-08-15-TESCO-BRITISH-CHICKEN-BREAST-FIL-CORRECTION-cddf22d1"],
    "recEZkGzmyxEoC880",
  ],
  [
    "halloumi",
    ...
    450,
    3.98,
    ["EVT-2026-08-15-TESCO-HALLOUMI-225G-CORRECTION-c5e8a2b3"],
    "rec3LhabANWwRpxYF",
  ],
  [
    "tomatoes",
  ...
  [
    ...
    4500,
    4.95,
    ["EVT-2026-08-15-SUPER-CRISPY-FRENCH-FRIES-CORRECTION-73ceaa8d"],
    "recOXyCPTMzFuaMdR",
  ],
  [
    "mushy peas",
  ...
  [
    "baked beans",
    "256947789",
    "Tesco Baked Beans In Tomato Sauce 4X420g",
    4,
    "x400g can",
    4,
    1,
  ...
  [
    "burger buns",
    "301971576",
    "St Pierre Plain Brioche Burger Buns 6 Pack",
    6,
    "item",
    6,
    1,
  ...
  [
    ...
    300,
    1.5,
    ["EVT-2026-08-15-TESCO-HOUMOUS-200G-CORRECTION-2c7f82c6"],
    "rec7NwbQ87VSbh3r6",
  ],
  [
    "lettuce",
