...
const lines: BasketLine[] = [
  ...
  ["chopped tomatoes","251825089","Tesco Italian Chopped Tomatoes 400G",800,"g",400,2,800,.94,["EVT-2026-08-15-TESCO-ITALIAN-CHOPPED-TOMATOES-4-CORRECTION-3559044e"],"rec6vfdbvu8F72bHc"],
  ["Garlic","313168547","Tesco Large Garlic",1,"each",1,1,1,.50,["EVT-2026-08-15-GARLIC-CORRECTION-0d922ef8"],"recuZb0sFtT5qCOuy"],
  ["celery","311672834","Tesco Celery",2,"stick",1,2,2,.75,[],"recEJgRI4YfKT7YV2"],
  ...
  ["lemon","TESCO-LEMONS-EACH","Tesco Lemons Each",2,"each",1,2,2,.74,[],"recuI3h9HcOpS0ntT"],
