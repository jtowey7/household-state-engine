...
const products: Array<[string,string,string,number,string,number,number,number,number,string[],string]> = [
...
const urls: Record<string,string> = {
  "254878424":"https://www.tesco.com/shop/en-GB/products/254878424","282470731":"https://www.tesco.com/shop/en-GB/products/282470731","251825089":"https://www.tesco.com/shop/en-GB/products/251825089","313168547":"https://www.tesco.com/shop/en-GB/products/313168547","311672834":"https://www.tesco.com/shop/en-GB/products/311672834","299770281":"https://www.tesco.com/shop/en-GB/products/299770281","292593115":"https://www.tesco.com/shop/en-GB/products/292593115","258421636":"https://www.tesco.com/shop/en-GB/products/258421636","TESCO-CHICKEN-1KG":"https://www.tesco.com/shop/en-GB/search?query=tesco+chicken+breast+fillet+1kg","295580293":"https://www.tesco.com/shop/en-GB/products/295580293","314098829":"https://www.tesco.com/shop/en-GB/products/314098829","266195171":"https://www.tesco.com/shop/en-GB/products/266195171","TESCO-LEMONS-EACH":"https://www.tesco.com/shop/en-GB/search?query=Tesco+Lemons+Each","299538966":"https://www.tesco.com/shop/en-GB/browse/frozen-food/chips-potatoes-and-sides/chips-and-french-fries/frozen-chips-straight-cut-chips","263903641":"https://www.tesco.com/shop/en-GB/products/263903641","288017298":"https://www.tesco.com/shop/en-GB/products/288017298","256947789":"https://www.tesco.com/shop/en-GB/products/256947789","301971576":"https://www.tesco.com/shop/en-GB/products/301971576","259061829":"https://www.tesco.com/shop/en-GB/products/259061829","255081368":"https://www.tesco.com/shop/en-GB/products/255081368","320967265":"https://www.tesco.com/shop/en-GB/products/320967265","253557495":"https://www.tesco.com/shop/en-GB/products/253557495",
};

const lines = products.map(([itemKey,sku,productName,requiredQuantity,unit,packSize,packCount,orderedQuantity,lineCost,sourceEventIds,requirementId]) => ({
  itemKey, sku, productName, productUrl: urls[sku], retailer: "Tesco", requiredQuantity, unit,
  packSize, packUnit: unit, packCount, orderedQuantity, lineCost, sourceEventIds,
  requirementIds: [requirementId], requirementCount: 1,
}));

const basket = {
  basketId: "Family Alpha MVP basket — 24–30 Aug 2026 — catalogue-verified",
  ...
  retailer: "Tesco", lines, exceptions: [], totalCost: 72.54,
  coverage: { demandItemKeys: lines.map(l=>l.itemKey), sourcedItemKeys: lines.map(l=>l.itemKey), unsourcedItemKeys: [], complete: true },
  complete: true, readyForReview: true, readyForApproval: true, dispatched: false, requiresHumanApproval: true,
};

if (!runtimeUrl || !writeToken) { console.error("Missing FOODOS_BASKET_RUNTIME_URL or FOODOS_BASKET_WRITE_TOKEN; refusing to send."); process.exit(2); }
...
const response = await fetch(`${runtimeUrl.replace(/\/$/, "")}/runtime/basket/candidate`, {
  ...
  body: JSON.stringify({ basket, runId: `family-alpha-basket-prepare-${new Date().toISOString()}` }),
});
