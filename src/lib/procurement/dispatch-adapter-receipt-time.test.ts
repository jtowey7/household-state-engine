...
function approved() { const basket = aggregateCandidateBasket(plan, { catalogue: shadowCatalogue, retailer: "synthetic-grocer" }); const approval = approveBasket(createBasketApproval(basket), basket, "James", "2026-08-17T12:00:00.000Z"); return { basket, approval, evidence: dispatchEvidence(basket.totalCost) }; }
