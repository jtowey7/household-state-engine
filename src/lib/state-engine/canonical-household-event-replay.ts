...
/**
 * Convert one canonical HOUSEHOLD EVENTS append record into the replay event
 * contract. No fields are guessed: quantity/unit must be explicit and the
 * event-type semantics must be one of the existing inventory mutations.
 */
