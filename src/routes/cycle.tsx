...
function CyclePage() {
  ...
  const nextAction = basketStatus === "APPROVED" && deliveryStatus !== "APPROVED"
    ...
    : deliveryStatus === "APPROVED"
      ? { label: "Keep food at home up to date", to: "/food" }
